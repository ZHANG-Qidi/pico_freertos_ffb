...
float _readADCVoltageLowSide(const int pin) { return _readADCVoltageInline(pin); }
...
void _configureADCLowSide(const int pinA, const int pinB, const int pinC) { _configureADCInline(pinA, pinB, pinC); }
